...
import time
from sensor_msgs.msg import CompressedImage, LaserScan
from ssafy_msgs.msg import BBox, TurtlebotStatus, Detection
...
def main(args=None):
    ...
    publisher_detect = g_node.create_publisher(Detection, '/laundry_detect', 3)
    ...
    while rclpy.ok():
        ...
        # cv2.imshow(winname, results.pred[0].cpu().numpy())
