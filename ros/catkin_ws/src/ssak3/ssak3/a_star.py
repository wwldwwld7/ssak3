    ...
    def goal_callback(self,msg):
        ...
        if msg.header.frame_id=='map':
            ...
            if self.is_map ==True and self.is_odom==True  :
                ...
                print("현재 위치 ?? : {}".format(start_grid_cell))
                print("목표 위치 ?? : {}".format(self.goal))
                ...
                print("시작점 : {} 목표점 : {}".format(self.grid[start_grid_cell[0]][start_grid_cell[1]], self.grid[self.goal[0]][self.goal[1]]))
